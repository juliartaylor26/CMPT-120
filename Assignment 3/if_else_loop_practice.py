# first of all, breathe don't let this intimidate you. break it down a part at a time. You've done all of these
# separately and now we're just combining them.
"""
